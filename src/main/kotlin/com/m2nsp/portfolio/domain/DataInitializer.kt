package com.m2nsp.portfolio.domain
...
@Component
@Profile(value = ["default"])       //datalinitializer은 프로필이 default일 때만 실행됨
    ...
    fun initializeData(){
        ...
        val achievements = mutableListOf<Achievement>(
            ...
            Achievement(
                ...
                host = "한국산업인력공단",
                achievedDate = LocalDate.of(2020, 2, 9),
                isActive = true
            )
        )
        //achievementRepository 는 인터페이스 -- 메소드 안만들어서 비어있지만 스프링 데이터 JPA가 만들어주는 기능
        ...
        val project1 = Project(
            ...
            description = "유기묘 위치의 실시간 공유, 임시보호까지 연결해주는 서비스. 구글 맵스를 연동하여 유기묘 위치 정보를 직관적으로 나타냄",
            startYear = 2022,
            startMonth = 9,
            endYear = 2022,
            endMonth = 12,
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Gitub Repository", url = "https://github.com/infomuscle", isActive = true)
            )
        )
